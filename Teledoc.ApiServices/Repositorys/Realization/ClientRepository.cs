...
namespace Teledoc.ApiServices.Repositorys.Realization
{
    public sealed class ClientRepository : IClientRepository
    {
        ...
        public async Task AddAsync(Client client, CancellationToken cancellationToken = default)
        {
            ...
            _logger.LogInformation($"The client was added, INN: {client.TaxpayerIndividualNumber}");
        ...
        public async Task UpdateAsync(Client client, CancellationToken cancellationToken = default)
        {
            ...
            await _context.SaveChangesAsync(cancellationToken);
            _logger.LogInformation($"The client was updated, INN: {client.TaxpayerIndividualNumber}");
        ...
        public async Task DeleteAsync(Client client, CancellationToken cancellationToken = default)
        {
            ...
            await _context.SaveChangesAsync(cancellationToken);
            _logger.LogInformation($"The client was deleted, INN: {client.TaxpayerIndividualNumber}");
